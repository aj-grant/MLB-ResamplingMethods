...
We will switch the order presented in the book \emph{An Introduction to Statistical
...
and it mimics the sampling process by sampling with replacement from
...
\pandocbounded{\includegraphics[keepaspectratio]{MLB-ResamplingMethods_files/MLB-ResamplingMethods_files/figure-latex/unnamed-chunk-2-1.pdf}}
...
We now use the function \textbf{boot()}, from the library \textbf{boot}, to bootstrap the median. We will also compute it manually
...
\pandocbounded{\includegraphics[keepaspectratio]{MLB-ResamplingMethods_files/MLB-ResamplingMethods_files/figure-latex/boostrapexercise-1.pdf}}
...
performance is called the \textbf{testing data}.
...
\pandocbounded{\includegraphics[keepaspectratio]{MLB-ResamplingMethods_files/MLB-ResamplingMethods_files/figure-latex/unnamed-chunk-9-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{MLB-ResamplingMethods_files/MLB-ResamplingMethods_files/figure-latex/unnamed-chunk-11-1.pdf}}
...
\begin{verbatim}
##        X                id          fever_hours           age        sex           wcc          prevAB                sbi      
##  Min.   :   1.0   Min.   :   495   Min.   :   0.00   Min.   :0.010   F:1013   Min.   : 0.2368   No :1370   Bact         :  34  
##  1st Qu.: 587.8   1st Qu.:133039   1st Qu.:  24.00   1st Qu.:0.760   M:1335   1st Qu.: 7.9000   Yes: 978   NotApplicable:1752  
##  Median :1174.5   Median :160016   Median :  48.00   Median :1.525            Median :11.6000              Pneu         : 251  
##  Mean   :1174.5   Mean   :153698   Mean   :  80.06   Mean   :1.836            Mean   :12.6431              UTI          : 311  
##  3rd Qu.:1761.2   3rd Qu.:196030   3rd Qu.:  78.00   3rd Qu.:2.752            3rd Qu.:16.1000                                  
##  Max.   :2348.0   Max.   :229986   Max.   :3360.00   Max.   :4.990            Max.   :58.7000                                  
##       pct                 crp        
##  Min.   :8.647e-03   Min.   :  0.00  
##  1st Qu.:1.600e-01   1st Qu.: 11.83  
##  Median :7.600e-01   Median : 30.97  
##  Mean   :3.744e+00   Mean   : 48.41  
##  3rd Qu.:4.620e+00   3rd Qu.: 66.20  
...
\pandocbounded{\includegraphics[keepaspectratio]{MLB-ResamplingMethods_files/MLB-ResamplingMethods_files/figure-latex/unnamed-chunk-16-1.pdf}}
...
\tightlist
\item
  Load the dataset \emph{Pima.tr} in the package \emph{MASS} (you might need
  to install this package). This dataset consists of 200 observations
  of 8 variables: 7 variables which will be used as model
  ...
  Use the KNN algorithm to predict diabetes (\emph{type}) using all the predictors available.
...
\NormalTok{model.knn.diab  }\OtherTok{\textless{}{-}} \FunctionTok{train}\NormalTok{(type }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ., }
                   \AttributeTok{data =}\NormalTok{ Pima.tr, }
                   \AttributeTok{method=}\StringTok{"knn"}\NormalTok{,}
...
## Resampling: Cross-Validated (10 fold, repeated 10 times) 
## Summary of sample sizes: 180, 179, 180, 180, 180, 181, ... 
## Resampling results across tuning parameters:
## 
##   k   Accuracy   Kappa    
##    5  0.7297306  0.3630839
##    7  0.7153496  0.3220346
##    9  0.7163421  0.3229733
##   11  0.7258333  0.3434643
##   13  0.7389198  0.3665974
##   15  0.7384699  0.3588448
##   17  0.7349699  0.3583874
##   19  0.7264887  0.3363848
##   21  0.7229336  0.3242644
##   23  0.7254624  0.3290931
##   25  0.7318910  0.3411394
##   27  0.7344436  0.3486025
##   29  0.7309937  0.3418477
##   31  0.7324724  0.3443140
##   33  0.7389248  0.3562164
##   35  0.7488559  0.3764668
##   37  0.7458797  0.3691339
##   39  0.7454749  0.3656044
##   41  0.7443985  0.3617584
##   43  0.7443008  0.3603597
## 
## Accuracy was used to select the optimal model using the largest value.
...
\pandocbounded{\includegraphics[keepaspectratio]{MLB-ResamplingMethods_files/MLB-ResamplingMethods_files/figure-latex/unnamed-chunk-17-1.pdf}}
