...
## Introduction {#boot.intro}
 ...
 <iframe width="784" height="441" src="https://www.youtube.com/embed/U8r-UrwTOy4" 
...
We now use the function **boot()**, from the library **boot**, to bootstrap the median. We will also compute it manually
...
## Exercises {#boot.exerc}

Solve the following exercises:

The [diabetes data](https://www.dropbox.com/s/4t7nph5d97hq0qh/diabetes.csv?dl=1)
